...
export class AuthService {
  private userRepo = prisma.user
  private profileRepo = prisma.participantProfile
  private surveyRepo = prisma.surveyVersion
  private spRepo = prisma.surveyParticipant

  public async createParticipant(participantData: RegisterParticipantRequest) {
